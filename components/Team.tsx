    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="w-full bg-primary bg-opacity-60 rounded-lg p-12 flex flex-col justify-center items-center">
            ...
            <div className="text-center">
                <a href="https://github.com/wowjeeez" className="text-xl hover:underline text-gray-700 font-bold mb-2">WowJeeez</a>
                <p className="text-base text-gray-400 font-normal">Head Developer</p>
            </div>
        </div>
        <div className="w-full bg-primary bg-opacity-60 rounded-lg p-12 flex flex-col justify-center items-center">
            <div className="mb-8">
            ...
            <div className="text-center">
                <a href="https://github.com/Hamy-os" className="text-xl text-gray-700 font-bold mb-2">Hamy-os</a>
                <p className="text-base text-gray-400 font-normal">Management</p>
            </div>
        </div>
        <div className="w-full bg-primary bg-opacity-60 rounded-lg p-12 flex flex-col justify-center items-center">
            <div className="mb-8">
            ...
            <div className="text-center">
                <p className="text-xl text-gray-700 font-bold mb-2">We are looking for new developers!</p>
                <a href="https://discord.com/users/656091979456839700" className="text-base btn text-gray-400 font-normal">Apply</a>
            </div>
        </div>
    </div>
</section>
